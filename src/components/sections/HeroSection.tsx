...
const HeroSection: React.FC = () => {
  return (
    <section className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="w-full bg-gradient-to-b from-black/80 to-black/90 py-8">
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center max-w-4xl mx-auto px-6">
          <Link 
            to="/quiz" 
